...
func TestCreatePerZoneAPIShieldClientCertificate(t *testing.T) {
	setup()
	defer teardown()
	...
	actual, err := client.CreatePerZoneAPIShieldClientCertificate(context.Background(), "023e105f4ecef8ad9ca31a8372d0c353", params)
	if assert.NoError(t, err) {
		assert.Equal(t, want, actual)
	}
}

func TestGetPerZoneAPIShieldClientCertificateDetails(t *testing.T) {
	setup()
	defer teardown()
	...
	mux.HandleFunc("/zones/023e105f4ecef8ad9ca31a8372d0c353/client_certificates/023e105f4ecef8ad9ca31a8372d0c353", handler)
	expiresOn, _ := time.Parse(time.RFC3339, "2033-02-20T23:18:00Z")
	issuedOn, _ := time.Parse(time.RFC3339, "2023-02-23T23:18:00Z")
	want := PerZoneAPIShieldClientCertificateDetails{
		Certificate: "-----BEGIN CERTIFICATE-----\nMIIDmDCCAoC...dhDDE\n-----END CERTIFICATE-----",
	...
	actual, err := client.GetPerZoneAPIShieldClientCertificateDetails(context.Background(), "023e105f4ecef8ad9ca31a8372d0c353", "023e105f4ecef8ad9ca31a8372d0c353")
	if assert.NoError(t, err) {
		assert.Equal(t, want, actual)
	}
}
